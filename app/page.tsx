...
export default function Home() {
  ...
  useEffect(() => {
    ...
    function animateProgress(ts: number) {
      ...
      if (percent < 100) {
        ...
        setTimeout(() => setLoading(false), 400); // fade out after 400ms
      }
    }
    frame = requestAnimationFrame(animateProgress);
  ...
  return (
    <div className='relative w-full min-h-screen overflow-hidden'>
      ...
      {/* Three.js Animated Blob Background */}
      <Canvas
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        <div className="max-w-2xl w-full flex flex-col items-center">
          ...
          <TimelineContent
            ...
            className="inline-block mb-4 px-4 py-1 rounded-xl border border-orange-600/80 text-xs font-medium tracking-tighter text-white/90 uppercase shadow-sm max-w-lg mx-auto bg-orange-600/10"
          >
            IFNMG <em>CAMPUS</em> JANUÁRIA
          </TimelineContent>
          {/* Main Title */}
          <TimelineContent
            as="h1"
            ...
            timelineRef={heroRef}
            variants={revealVariants}
            className="text-3xl lg:text-3xl xl:text-5xl font-medium tracking-tighter text-white mb-6"
          >
